...
app.get('/', function(req, res){
	...
	res.sendFile( 'C:/wamp/www/gregoire/self_learning/nodeJS/chat.html');
...
nsp.on( 'connection' , function( socket ) {
	...
	socket.on( 'is_typing' , function( nickname ) {

		socket.broadcast.emit( 'broadcast' , nickname + ' is typing...' );
